...
# --- 2. Success Filtering: Time threshold (<= 300s) ---
def is_success(row):
    try:
...
final_df.to_csv('b04_statistics_time_threshold.csv', index=False)
print("\nResults successfully saved to 'b04_statistics_time_threshold.csv'.")
