...
(assert (forall 
	...
	(=> 
		(and
			...
			(= error0 (- 2500.000000 currentvalue))
			(= controloutput0 (* 0.030600 error0))
	...
	(=> 
		(and
			...
			(not (=> 
				(>= i0 9000.000000) 
				(and
					(<= (- 0.0 1.000000) (- 2500.000000 currentvalue0)) (<= (- 2500.000000 currentvalue0) 1.000000)
				)))
		)
		false)
))
