...
(assert (forall 
	...
	(=>
		(and
			(<= 4500.000000 currentvalue)
            (<= currentvalue 18000.000000)
			(= i 0.0)
		)
...
(assert (forall 
	...
	(=> 
		(and
			...
			(= error0 (- 1000.000000 currentvalue))
			(= controloutput0 (* 0.090000 error0))
	...
	(=> 
		(and
			...
			(not (=> 
				(>= i0 9000.000000) 
				(and
					(<= (- 0.0 1.000000) (- 1000.000000 currentvalue0)) (<= (- 1000.000000 currentvalue0) 1.000000)
				)))
		)
		false)
))
