...
int main() {
  ...
  const double R2_MIN = 4000.0;
  const double R2_MAX = 4000.0;
  const double R3_MIN = 5000.0;
  const double R3_MAX = 5000.0;
  const double R35_MIN = 5000.0;
  const double R35_MAX = 5000.0;
  const double R4_MIN = 0.08;
  const double R4_MAX = 0.12;
  const double R5_MIN = 110.0;
  const double R5_MAX = 10000.0;
  const double R6_MIN = 0.5;
  const double R6_MAX = 1.0;
  const double R7_MIN = 0.5;
  const double R7_MAX = 1.0;
  // =================================================
