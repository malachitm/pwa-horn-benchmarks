...
; + currentvalue is the square root of 2
...
(assert (forall 
	...
	(=>
		...
		( Inv currentvalue error controloutput controlsignal i r0 r1 n a0))
))
...
(assert (forall 
	((currentvalue Real)
     ...
     (r00 Real) (r10 Real) (n0 Real) (a0 Real)
	)
	...
	(=> 
		...
		(Inv currentvalue0 error0 controloutput0 controlsignal0 i0 r00 r10 n0 a0))
))
